...
public class DataModelUsuario {
    ...
    public static  String criarTabelaInfoGeral(){
        ...
        queryCriarTabelaInfoGeral += id + " INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, ";
    ...
    public static String criarTabelaPerfil(){
        ...
        queryCriarTabelaPerfil += id + " INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, ";
        ...
        queryCriarTabelaPerfil += "info_geral_cadastros_id INTEGER REFERENCES "+ getTabelaInfoGeral() + "(id) AUTOINCREMENT ";
        queryCriarTabelaPerfil += " )";
